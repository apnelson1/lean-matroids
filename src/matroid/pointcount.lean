...
begin
  ...
  simp_rw [← nonloop_iff_not_elem_loops, ← parallel_refl_iff_nonloop, ← ps_rel_eq_parallel, 
...
begin
  ...
  split,
  { rintros ⟨x,hx⟩, 
    rw [mem_inter_iff, mem_diff, ← nonloop_iff_not_elem_loops] at hx,
  ...
  subtype.coe_mk, ← nonloop_iff_not_elem_loops] at ⊢ hx, 
