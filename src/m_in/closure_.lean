...
begin
  -- rw [cl_eq_cl_inter_ground, inter_distrib_right, cl_eq_cl_inter_ground _ (X ∪ Y), 
  --   inter_distrib_right], 
...
begin
  ...
  have hF : M.flat F, 
  {
    refine ⟨λ J Y hJ hJY y hy, 
      hI.basis_of_forall_insert (subset_insert _ _) (λ e he heI, _ ) 
      (insert_subset.mpr ⟨hJY.subset_ground hy,by ssE⟩), 
      hIF.subset_ground⟩, 
    sorry
    -- refine λ J Y hJ hJY y hy, (hI.basis_of_forall_insert _ (subset_insert _ _) (λ e he heI, _)), 
